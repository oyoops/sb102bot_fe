    ...
    const messages = [{
        ...
        "content": `
            CONTEXT:
                ...
                You are a real estate analyst creating a multifamily comps analysis.
            YOUR TASK:
                You will be given information about a subject site and the raw data about apartment comps within a 3-mile radius.
                Based on the info, you will produce intelligent insights about apartments in this submarket.
                    Analyze the comps' rents, unit sizes, building ages, and more in great detail.
            RULES:
                You must refer to all comps by their names!
            FORMAT:
        ...
        "content": `
            ...
            --
            APARTMENT COMPS WITHIN A 3-MILE RADIUS:
                ${compsDataRaw}

            COMPS' AVERAGES:
                ${compsAvgs}

            COMPS' UNIT MIX (WEIGHTED AVERAGES %):
                ${compsPcts}
        `
    }];
