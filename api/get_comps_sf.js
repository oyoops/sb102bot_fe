...
module.exports = async (req, res) => {
  ...
  try {
    const query = `
      ...
      SELECT 
          ROUND(AVG(st_avg_sf)) AS avg_st_avg_sf,
          ROUND(AVG(one_bd_avg_sf)) AS avg_one_bd_avg_sf,
          ROUND(AVG(two_bd_avg_sf)) AS avg_two_bd_avg_sf,
          ROUND(AVG(three_bd_avg_sf)) AS avg_three_bd_avg_sf
      FROM 
