...
file_names = ['public/index.html', 'public/main.js', 'public/acreageCalculation.js', 'api/load_county_table.js', 'api/aggregate_county_data.js', 'public/styles.css']
...
# Output file names
zip_file_name = '_saves/_combined-code-sb102bot-fe.zip' # Output zip file name
txt_file_name = '_saves/_combined-code-sb102bot-fe.txt' # Output text file name
